        ...
        for child in children:
            ...
            if color == "G":
                if new_position[1] == -1 or new_position[1] == 1:  # left or right
                    child.g = current_node.g + 2  # for "G" left-right cost is 1
                if new_position[0] == -1 or new_position[0] == 1:  # up or down
                    child.g = current_node.g + 1  # for "G" up-down cost is 2
                print("------------------------",child.g)


            if color == "B":
                if new_position[1] == -1 or new_position[1] == 1:  # left or right
                    child.g = current_node.g + 1  # for "B" left-right cost is 2
                if new_position[0] == -1 or new_position[0] == 1:  # up or down
